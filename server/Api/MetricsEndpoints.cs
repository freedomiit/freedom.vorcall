...
public static class MetricsEndpoints
{
    ...
    private static string Render(RegistrySnapshot registry, RelaySnapshot relay, ServerMetrics metrics)
    {
        ...
        Declare(body, "vorcall_rooms", "gauge", "Rooms the presence mirror holds.");
        Sample(body, "vorcall_rooms", registry.Rooms);

        Declare(body, "vorcall_voice_sessions", "gauge", "Voice slots held across all rooms.");
