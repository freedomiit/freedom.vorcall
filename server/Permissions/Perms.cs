...
{
    // The 25 defined bits.
    public const ulong All = 0x1FFFFFF;
    ...
    // ADD_REACTIONS | CONNECT | SPEAK | SHARE_SCREEN | CHANGE_NICKNAME | SOUNDPAD | VIDEO.
    public const ulong EveryoneDefault = 11595520;
