...
//!
//! rodio is compiled without decoders, so there is no file to play: the sound
//! is two short synthesized notes.
...
/// mixer, so the sink has to outlive every sound handed to it.
pub struct Audio {
